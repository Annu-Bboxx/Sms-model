...
def main():
    ...
    module = importlib.import_module('src.Queries.{}'.format(train_query_file))
    ...
    persist_training_components(mt, version, final_classifier, schema, train_date, raw_train_data, train_data,
                                tuned_hyperparameters, meta_data)
